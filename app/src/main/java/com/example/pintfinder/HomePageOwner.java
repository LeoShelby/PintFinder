...
public class HomePageOwner extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_page_owner);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(HomePageOwner.this,CreatePubActivity.class);
                startActivity(i);
            }
        });
        ...
        if(SingletonUsers.Instance().getUser().equals("paul")) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //getMenuInflater().inflate(R.menu.home_page_owner, menu);
        return true;
    }
