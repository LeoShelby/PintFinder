...
public class HorizontalPubListAdapter extends RecyclerView.Adapter<HorizontalPubListAdapter.ViewHolder> {
    ...
    public HorizontalPubListAdapter(List<Pub> books, Activity activity) {
        mBooks = books;
    ...
    @NonNull
    @Override
    public HorizontalPubListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        Context context = viewGroup.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        // Inflate the custom layout
        View bookView = inflater.inflate(R.layout.pub_item_layout, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull HorizontalPubListAdapter.ViewHolder myViewHolder, int i) {
